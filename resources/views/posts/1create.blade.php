         ...
         <div class="card">
            <div class="card-body">
                     ...
                     <div class="form-group">
                        ...
                        <select id="select_category_parent" value="{{ old('category_id') }}" name="category_id" data-placeholder="Pilih kategori" 
                    ...
                    <div class="form-group">
                     ...
                     <input type="file" name="thumbnail" value="{{ old('thumbnail') }}" class="form-control @error('thumbnail') is-invalid @enderror">
                      @error('thumbnail')
                              <span class="invalid-feedback">
                                 <strong>
                                    {{ $message }}
