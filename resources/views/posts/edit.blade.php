...
@section('title', 'Edit Jasa Layanan')

@section('header-title', 'Edit Jasa Layanan')
                       ...
                       <div class="form-group">
                          ...
                          <div class="input-group">
                             <div class="input-group-prepend">
                              ...
                              <input id="input_post_thumbnail" name="thumbnail" value="{{ old('thumbnail', asset($post->thumbnail)) }}" 
