...
@section('title', 'Tambah Sub Jasa')

@section('header-title', 'Tambah Sub Jasa')

@section('breadcrumbs')
{{ Breadcrumbs::render('add_subkategories') }}
@endsection
...
<div class="row">
    <div class="col-md-12">
       <div class="card">
          <div class="card-body">
             <form action="{{ route('subjasa.store') }}" method="POST">
                @csrf
                <!-- parent_category -->
                <div class="form-group">
                   ...
                   class="custom-select w-100">
                    @if(old('jenisjasa_id'))
                        <option value="{{ old('jenisjasa_id')->id }}" selected>
                            {{ old('jenisjasa_id')->title }}
                        </option>
                    @endif
                   </select>
                </div>
