...
<div class="container-fluid px-1 py-5 mx-auto">
    <div class="row d-flex justify-content-center">
        <div class="col-xl-4 col-lg-5 col-md-6 col-8 text-center">
            <h3 class="text-light">TARIF BLU</h3>
            <div class="card mt-3">
                <h5 class="text-center mb-4">Register</h5>
                <form class="form-card" onsubmit="event.preventDefault()">
                    <form method="POST" action="{{ route('visitors.store.visitor') }}">
                       @csrf
                        ...
                        <div class="row justify-content-between">
                            <div class="form-group col-sm-12"> <button type="submit" class="btn-block btn-warning text-light">Lihat Tarif</button> </div>
                        </div>
                    </form>
                </form>
            </div>
