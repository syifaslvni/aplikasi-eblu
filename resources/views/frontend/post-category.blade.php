  ...
  <body>
    ...
    <div class="container mt-5">
        <div class="judul-NamaJasa" style="background-color: #fff; padding: 5px 10px;">
          <h5 class="text-center" style="margin-top: 5px;">{{ $category->title }}</h5>
        </div>
        
        <div class="row">
          @forelse ($posts as $post)
          <div class="col-lg-3 col-md-3 col-sm-6 col-8 mt-2 mt-2">
              <div class="card text-center">
                ...
                <div class="card-body">
                  ...
                  <a href="{{ route('home.post.detail', ['slug' => $post->slug]) }}" class="btn btn-warning d-grid">Rincian</a>
                </div>
              </div>
            </div>
          @empty
